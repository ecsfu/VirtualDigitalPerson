...
DICT_EN = 'MFA/aligner/cmudict-0.7b'
DICT_ZH = 'MFA/aligner/simple.lexicon'
MODEL_DIR_EN = 'MFA/aligner/vctk_model.zip'
MODEL_DIR_ZH = 'MFA/aligner/aishell3_model.zip'
MFA_PHONE_EN = 'MFA/aligner/vctk_model/meta.yaml'
MFA_PHONE_ZH = 'MFA/aligner/aishell3_model/meta.yaml'
# MFA_PATH = 'MFA/montreal-forced-aligner/bin'
...
def get_check_result(label_file: Union[str, Path],
    ...
    oov_words, oov_files, oov_file_words = check_phone(
        ...
        am_phones=am_phones,
        oov_record=os.path.join(input_dir,"../oov_info.txt"),
        lang=lang)
